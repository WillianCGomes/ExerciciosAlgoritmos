...
public class Exercicio51 {
	...
	public static void main(String[] args) {
		...
		if ((v1 < v2) && (v2 < v3) || (v2 < v1) && (v1 < v3)) {
			mult = (v1 * v2);
			JOptionPane.showMessageDialog(null, "A multiplicação dos 2 primeiros valores foi de: " + mult);
		} else if ((v3 < v1) && (v1 < v2) || (v1 < v3) && (v3 < v2)) {
			mult = (v1 * v3);
			JOptionPane.showMessageDialog(null, "A multiplicação do primeiro e último valor foi de: " + mult);
		} else {
			mult = (v2 * v3);
			JOptionPane.showMessageDialog(null, "A multiplicação dos 2 últimos valores foi de: " + mult);
		}
