...
public class AlunoController {
    ...
    public void inserir(Aluno aluno) {
        ...
        try {
            ...
            //mensagem de sucesso            
            JOptionPane.showMessageDialog(null, Mensagem.aluno_inserir_ok, Titulo.inserir_aluno, 1);

        } catch (Exception ex) {
            Logger.getLogger(AlunoController.class.getName()).log(Level.SEVERE, null, ex);

            //mensagem de erro
            JOptionPane.showMessageDialog(null, Mensagem.aluno_inserir_n_ok, Titulo.inserir_aluno, 0);
    ...
    public void alterar(Aluno aluno) {
        ...
        try {
            ...
            //mensagem de sucesso            
            JOptionPane.showMessageDialog(null, Mensagem.aluno_alterar_ok, Titulo.alterar_aluno, 1);

        } catch (Exception ex) {
            Logger.getLogger(AlunoController.class.getName()).log(Level.SEVERE, null, ex);

            //mensagem de erro
            JOptionPane.showMessageDialog(null, Mensagem.aluno_alterar_n_ok, Titulo.alterar_aluno, 0);
    ...
    public void excluir(Aluno aluno) {
        ...
        try {
            ...
            //mensagem de sucesso            
            JOptionPane.showMessageDialog(null, Mensagem.aluno_excluir_ok, Titulo.excluir_aluno, 1);

        } catch (Exception ex) {
            Logger.getLogger(AlunoController.class.getName()).log(Level.SEVERE, null, ex);

            //mensagem de erro
            JOptionPane.showMessageDialog(null, Mensagem.aluno_excluir_n_ok, Titulo.excluir_aluno, 0);
    ...
    public ArrayList<Aluno> buscarTodos() {
        ...
        try {
            ...
            Logger.getLogger(AlunoController.class.getName()).log(Level.SEVERE, null, ex);
            //mensagem de erro
            JOptionPane.showMessageDialog(null, Mensagem.aluno_consultar_n_ok, Titulo.consultar_aluno, 0);
        }
  ...
  //verificando se o usuário selecionou algum registro
        if (tela.getTabela().getSelectedRow() < 0) {
            ...
            int opcao = JOptionPane.showConfirmDialog(null, Mensagem.excluir_pergunta, Titulo.excluir_aluno, JOptionPane.YES_OPTION, JOptionPane.CANCEL_OPTION);
