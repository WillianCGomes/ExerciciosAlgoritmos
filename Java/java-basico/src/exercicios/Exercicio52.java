...
/**
 * Programa para verificar valores em ordem crescente
 * 
	...
	public static void main(String[] args) {
		...
		if ((A < B) && (B < C) && (C > A) && (C > B)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + A + ", " + B + ", " + C);
		} else if ((A < B) && (A < C) && (B > A) && (B > C)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + A + ", " + C + ", " + B);
		} else if ((A > B) && (A < C) && (B < C) && (C > A)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + B + ", " + A + ", " + C);
		} else if ((C < A) && (C < B) && (B > C) && (B > A)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + C + ", " + A + ", " + B);
		} else if ((C < A) && (C < B) && (B < A) && (B > C)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + C + ", " + B + ", " + A);
		} else if ((A > B) && (A > C) && (B < C) && (C < A)) {
			JOptionPane.showMessageDialog(null,
					"A ordem crescente dos números informados é: " + B + ", " + C + ", " + A);
		}
